...
public class InputData {
    ...
    private LocalDate repaymentStartDate = LocalDate.of(2020, 1, 6);  //Dzień od którego zaczynamy spłatę kredytu

    private BigDecimal wiborPercent = new BigDecimal("1.73");  //Procent wibor

    private BigDecimal amount = new BigDecimal("300000");   //Kwota kredytu
    private BigDecimal monthDuration = BigDecimal.valueOf(180);   //Czas trwania kredytu

    private RateType rateType = RateType.CONSTANT; // Typ kredytu może być malejący albo stały

    private BigDecimal bankMarginPercent = new BigDecimal("1.9"); //Marża banku

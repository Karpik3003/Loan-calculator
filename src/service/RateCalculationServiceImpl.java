...
public class RateCalculationServiceImpl implements RateCalculationService {
    ...
    private final ResidalCalculactionService residalCalculactionService;
    ...
    public RateCalculationServiceImpl(
            ...
            ResidalCalculactionService residalCalculactionService,
        ...
        this.residalCalculactionService = residalCalculactionService;
    ...
    private Rate calculateRate(BigDecimal rateNumber, InputData inputData) {
        ...
        MortgageResidual mortgageResidual = residalCalculactionService.calculate(rateAmounts,inputData);
    ...
    private Rate calculateRate(BigDecimal rateNumber, InputData inputData, Rate previousRate) {
        ...
        MortgageResidual mortgageResidual = residalCalculactionService.calculate(rateAmounts,previousRate);
